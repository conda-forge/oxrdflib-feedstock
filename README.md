...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oxrdflib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13723&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oxrdflib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oxrdflib` can be installed with:

```
conda install oxrdflib
```

It is possible to list all of the versions of `oxrdflib` available on your platform with:
